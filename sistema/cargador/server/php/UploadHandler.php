...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'../../docs/',
            'upload_url' => $this->get_full_url().'../../docs/',
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|mp4|pdf)$/i',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|mp4|pdf)$/i',
