...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    foreach($groups as $group) {
        ...
        $sql = "INSERT INTO `actividades_grupo`(`grupo`, `guia`, `name`, `tipo_actividad`, `actividad`, `doc_actividad`, `active`, `rr`)";
        $sql.= " VALUES('$group', '$guia', '$name', '$tipo_actividad',  '$actividad', '$doc', '$active', '$rr')";
        $result = query($sql);
        confirm($result);
