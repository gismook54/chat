...
class FileUpload {
    ...
    public $sizeLimit = 500000000;         // Max file upload size in bytes (default 10MB)
    ...
    public $uploadName = 'uploadfile_dos';
    ...
    public function handleUpload($uploadDir = null, $allowedExtensions = null) {
        ...
        if (!empty($this->allowedExtensions)) {
            if (!$this->checkExtension($this->fileExtension, $this->allowedExtensions)) {
                $this->setErrorMsg('Formato incorrecto, sólo se permite PDF, JPG, PNG');
                return false;
            }
        }
