...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "UPDATE `actividades_alumno` SET `alumno`='$alumno', `name`='$name', `tipo_actividad`='$tipo_actividad', `guia`='$guia', `created`='$updated', `actividad`='$actividad', $ins `active`='$active', `rr`='$rr'  WHERE `id`=$id";
    $result = query($sql);
    confirm($result);
