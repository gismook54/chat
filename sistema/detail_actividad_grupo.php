        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern main-content-narrow">
           ...
           <?php 
                ...
                switch ($tipoUsuario){
                    ...
                    $sqle = "SELECT * FROM `actividades_grupo` WHERE `id`='$idAct'";
                    $resulte = query($sqle);
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM `actividades_grupo` WHERE `id`='$idAct' AND `active`='1'";
                                $result = query($sql);
                        ...
                        <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                            <div class="block-options">
                                <button type="button" class="btn btn-alt-secondary" data-toggle="modal" data-target="#modal-reply" data-id="<?php echo $id?>" data-idal="<?php echo $isAlumno?>" data-idg="<?php echo $idgrupo ?>" data-idta="2"><i class="si si-cloud-upload"></i>&nbsp;Responder Actividad</button>
                            </div>
                        </div>
                        <?php
                                }
